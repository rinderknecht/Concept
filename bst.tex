...
\fig~\vref{fig_bst}.\index{bst@\fun{bst/1}}\index{bst1@\fun{bst\(_1\)/2}}
\begin{figure}[t]
\begin{equation*}
\boxed{
\begin{array}{r@{\;}l@{\;}l}
...
du premier. Nous avons vu \vpageref{par_rotation} que les parcours
...
\emph{membership}) est donnée à la \fig~\vref{fig_mem}.
\begin{figure}
\begin{equation*}
\boxed{
\begin{array}{r@{\;}l@{\;}l}
...
\end{array}}
\end{equation*}
\caption{Appartenance à un arbre binaire de recherche\label{fig_mem}}
\end{figure}
...
la \fig~\vref{fig_tree_stack} et~\vref{fig_zigzag}. Il est évident que
...
avons utilisées dans l'analyse du tri par interclassement\index{tri
  par interclassement}, au chapitre~\ref{chap_merge_sort}
\vpageref{chap_merge_sort}.
...
\fig~\vref{fig_insl1}.\index{insl1@\fun{insl/1}}
%\bigskip
%\bigskip
%\bigskip
\begin{figure}
...
que nous avons déjà rencontrée \vpageref{par_perfection} (l'arbre est
...
\vpageref{par_opt_sort_minimean}.
...
la section~\ref{sec_traversals} \vpageref{par_rotation} et sont
...
\fun{bst\(_0\)/1} à la \fig~\vref{fig_bst0}, et que celle-ci est
...
de \fun{insr/2}, à la \fig~\vref{fig_insr}.
\begin{figure}
\begin{equation*}
\boxed{
\begin{array}{r@{\;}l@{\;}l}
...
\begin{enumerate}
  ...
  \fun{pre/1} \index{pre@\fun{pre/1}} à la \fig~\vref{fig_pre}. Est-ce
