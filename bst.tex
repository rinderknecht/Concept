...
\centering
\includegraphics[bb=68 661 123 710]{bst_ex}
\caption{}
\label{fig:bst_ex}
\end{wrapfigure}
...
\(\OB{\fun{mkr}}{n}\)\index{mkr@$\OB{\fun{mkr}}{n}$} le nombre minimal
...
de nœuds internes, \fun{bst/3} et \fun{del/3}.\index{del@\fun{del/3}}
