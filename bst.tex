...
coût \citep{Burge_1976,ArchibaldClement_2006,Pasanen_2010}.
...
l'induction. D'abord, si \(\fun{in}_3(t) \equiv
\fun{in}_3(\fun{rotl}(t))\), alors remplacer \(t\) par
\(\fun{rotr}(t)\) donne
\begin{equation*}
...
arbres résultants diffère de la distribution des formes des arbres de
même taille produits uniquement par insertions. Plus surprenant,
peut-être, il a été démontré que les arbres construits par~\(n\)
insertions suivies de~\(m\) suppressions (\(n \geq m\)) ont bien la
même distribution de formes que les arbres construits par \(n-m\)
insertions! Ces phénomènes sont difficiles à comprendre et des
exemples sont nécessaires pour les voir à l'œuvre
