...
Dans l'introduction, \vpageref{par_java}, nous avons couché le patron
...
Comme nous l'avons vu à l'équation~\eqref{def_rev} \vpageref{def_rev},
...
Le tri par insertion a été défini à la section~\vref{sec_straight_ins}
ainsi:
\begin{equation*}
...
\fun{cutr/3}, définie à la \fig~\vref{fig_tms}:
\begin{equation*}
\begin{array}{@{}r@{\;}l@{\;}l@{}}
...
\end{array}}
\end{equation*}
\caption{Découpage et interclassement descendant\label{fig_cutr}}
\end{figure}
