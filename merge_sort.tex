...
\noindent Des équations \eqref{eq:bot} et \eqref{eq:2p}, il vient
\index{bms@$\OW{\fun{bms}}{n}$}
\begin{align*}
\OW{\fun{bms}}{2^p+i} &=
...
d'induction.  Par conséquent, si l'inégalité \(\OW{\fun{tms}}{2^p} +
...
\end{align*}
Par conséquent, nous avons seulement besoin de prouver que
