...
\end{array}}
\end{equation*}
\caption{Interclasser deux piles triées\label{fig:mrg}
...
\caption{\(\fun{mrg}([3,4,7],[1,2,5,6]) \twoheadrightarrow
  [1,2,3,4,5,6,7]\)\label{fig:mrg_247}\index{tri par
...
\caption{Dénombrement vertical\label{fig:mean_mrg2}}
\end{figure}
...
la règle~\(\theta\) ou~\(\iota\) à la \fig~\ref{fig:mrg}, comme nous
...
équations~\eqref{eq_Amrg_n_n} et~\eqref{def:cost_mrg} donnent
\begin{equation*}
%\abovedisplayskip=2pt
...
\end{array}}
\end{equation*}
\caption{Tri par interclassement descendant avec \fun{tms/1}\label{fig:tms}}
\end{figure}
...
\caption{\(\Phi(p,1)\), \(\Phi(p,2)\) et \(\Phi(p,3)\)\label{fig:phi}}
\end{figure}
...
\end{array}}
\end{equation*}
\caption{Tri par interclassement ascendant avec \fun{bms/1}\label{fig:bms}}
\end{figure}
...
\end{array}}
\end{equation*}
\caption{Tri ascendant accéléré avec \fun{bms\(_0\)/1}\label{fig:bms0}}
\end{figure}
...
\end{array}}
\end{equation*}
\caption{Tri par interclassement en ligne avec \fun{oms/1}\label{fig:oms}}
\end{figure}
