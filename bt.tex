...
\end{array}}
\end{equation*}
\caption{Parcours préfixe avec \fun{flat/1}\label{fig:pre1}}
\end{figure}
...
\end{equation*}
\caption{Version de \fun{npre/1} sans système d'inférence\label{fig:npre_bis}}
\end{figure}
\index{arbre binaire!préfixe|)}
...
\end{array}}
\end{equation*}
\caption{Aplatir comme \fun{lpre/1}\label{fig:flat2}}
\end{figure}
...
\caption{Parcours par niveaux avec \fun{bf\(_0\)/1}\label{fig:lo0}}
\end{figure}
