...
\label{fig_flat0}\index{pile!aplatissement!définition}}
\end{figure}

Considérons un exemple à la \fig~\vref{fig_flat0_ex},
\begin{figure}
\begin{equation*}
\boxed{%
\begin{array}{r@{\;}l@{\;}l}
...
\label{fig_flat0_ex}\index{pile!aplatissement!exemple}}
\end{figure}
...
\label{fig_cat_min1}]{\includegraphics[bb=66 660 200 722]{cat_min1}}
\quad
\subfloat[Si \(\Omega < \Gamma\), le minimum est \(2\Gamma-\Omega\).
\label{fig_cat_min2}]{\includegraphics[bb=70 643 230 721]{cat_min2}}
...
\begin{figure}
\centering
\subfloat[Coût maximum \((n+1)\Gamma\)\label{fig_cat_max}]{
\includegraphics[bb=71 660 188 721]{cat_max}}
\qquad
\subfloat[$\protect\fun{flat}(\cons{\cons{x}{s}}{t})$\label{fig_lift1}]%
{\includegraphics[bb=55 661 122 721]{flat_embed}}
\qquad
\subfloat[$\protect\fun{flat}(\cons{x,s}{t})$\label{fig_lift2}]%
...
\figs~\vrefrange{fig_lift1}{fig_lift2}, où la nouvelle fonction est
...
de Ackermann (section~\ref{par_ackermann}, \vpageref{par_ackermann}),
...
(section~\ref{par_well-founded}, \vpageref{par_well-founded}), elle
...
\fun{flat/1}\index{flat@\fun{flat/1}} à la \fig~\vref{fig_flat} et
