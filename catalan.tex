...
\centering
\includegraphics[bb=71 646 160 704]{catalan_tree}
...
%% Ce dénombrement a une intéressante conséquence pour la programmation
...
%% un constructeur de donnée \fun{tree} avec une paire d'arguments: le
...
Le point-clé est que chaque montée atteignant le niveau~\(l\) à la
